                ...
                <div class="bg-white/5 backdrop-blur-md border border-white/10 shadow-xl sm:rounded-2xl overflow-hidden p-8">
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input v-model="form.name" type="text" required placeholder="e.g. Playing Guitar, Hiking" 
                        ...
                        <div>
                            ...
                            <textarea v-model="form.description" rows="3" placeholder="A brief note about this interest..." 
                        ...
                        <div class="pt-6 border-t border-white/10">
                            <button type="submit" :disabled="form.processing" 
                                ...
                                {{ form.processing ? 'Applying...' : 'Create Interest' }}
                            </button>
                        </div>
                    </form>
                </div>
